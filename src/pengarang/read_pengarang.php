...
<body>
  ...
  <div class="container">
    <button class="btn-primary" style="border-radius: 10px;">
      <a href="create_pengarang.php" style="color: white; text-decoration: none">Tambah Data</a>
    </button>
    <button class="btn-primary" style="border-radius: 10px;">
    ...
    ?>
      <tbody>
        <tr>
          ...
          <td>
            <a href="edit_pengarang.php?id=<?php echo $d['id']; ?>">Edit</a>
            <a href="delete_pengarang.php?id=<?php echo $d['id']; ?>">Delete</a>
          </td>
        </tr>
      </tbody>
    <?php
